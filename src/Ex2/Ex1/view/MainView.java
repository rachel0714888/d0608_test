 ...
 * @date 2023/5/22 7:58
 */
public class MainView {private static Scanner sc = new Scanner(System.in);
    private static UserService userService = new UserService();

    public static void mainView() {
        Print.print("欢迎来到XX系统");
    ...
    public static void updateUser(){
        ...
        if(!flag){
            ...
            com.iweb.exc.view.MainView.userView();
        }else {
            Print.print("重新输入修改信息!");
            com.iweb.exc.view.MainView.updateUser();
        }
    }
}
